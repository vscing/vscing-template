<template>
    <div class="main">
        <content-title title="视频库" :onHelp="handleDelete">
            <template #rightView>
                <!--                <div style="text-align: right">123</div>-->
            </template>
        </content-title>
        <screen-form title="视频名称" :screenForm="screenForm" :submitForm="submitForm"></screen-form>
        <el-row>
        ...
        <resource-upload
                ...
                :fileType="2"
                :size="30"
                :extRule="['ogg', 'mp4', 'webm']"
        >
            <template #text>
                将视频拖到此处，或<em>点击上传</em>
            </template>
            <template #tips>
                只能上传ogg、mp4、webm文件，且不超过30mb
            </template>
        </resource-upload>
        <el-table
                class="mt20"
...
<!--                    <div class="img-box">-->
<!--                        <video :src="uploadHost+scope.row.file_url" controls="controls"></video>-->
<!--                    </div>-->
<!--                </template>-->
<!--            </el-table-column>-->
            <el-table-column
