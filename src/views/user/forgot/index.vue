...
import { getForgotCode, forgot, getCodeImage } from '@/api/user';
...
console.log('%c [ userStore ]-35', 'font-size:13px; background:pink; color:#bf2c9f;', userStore)
...
const sendCode = async() => {
  ...
  if(sendSms.value && times.value === 120) {
    const [_, res] = await to(getForgotCode({
      phone: phone.value,
